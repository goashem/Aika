...
from ..models import (
    ...
    AuroraForecast, TransportDisruptions, CO2Intensity
)
...
def get_electricity(now, timezone, country_code):
    ...
    co2_model = None
    if co2_data:
        co2_model = CO2Intensity(
            intensity=co2_data.get("intensity", 0.0),
            unit=co2_data.get("unit", "gCO2/kWh"),
            level=co2_data.get("level", "low")
        )
