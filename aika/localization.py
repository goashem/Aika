...
def get_finnish_translations():
    ...
    finnish_months = {
        "January": "tammikuu", "February": "helmikuu", "March": "maaliskuu",
        "April": "huhtikuu", "May": "toukokuu", "June": "kesakuu",
        "July": "heinakuu", "August": "elokuu", "September": "syyskuu",
        "October": "lokakuu", "November": "marraskuu", "December": "joulukuu"
    }

    finnish_months_genitive = {
        "January": "tammikuuta", "February": "helmikuuta", "March": "maaliskuuta",
        "April": "huhtikuuta", "May": "toukokuuta", "June": "kesakuuta",
        "July": "heinakuuta", "August": "elokuuta", "September": "syyskuuta",
        "October": "lokakuuta", "November": "marraskuuta", "December": "joulukuuta"
    }
...
def get_finnish_hour(hour):
    ...
    finnish_hours = {
        1: "yksi", 2: "kaksi", 3: "kolme", 4: "nelja", 5: "viisi", 6: "kuusi",
        7: "seitseman", 8: "kahdeksan", 9: "yhdeksan", 10: "kymmenen",
...
HOLIDAY_TRANSLATIONS = {
    ...
    'Uudenvuodenpaiva': 'New Year\'s Day',
    'Loppiainen': 'Epiphany',
    'Pitkaperjantai': 'Good Friday',
    'Paasiaispaiva': 'Easter Sunday',
    'Toinen paasiaispaiva': 'Easter Monday',
    'Vappu': 'May Day',
    'Helatorstai': 'Ascension Day',
    'Helluntaipaiva': 'Whit Sunday',
    'Juhannusaatto': 'Midsummer Eve',
    'Juhannuspaiva': 'Midsummer Day',
    'Pyhainpaiva': 'All Saints\' Day',
    'Itsenaisyyspaiva': 'Independence Day',
    'Jouluaatto': 'Christmas Eve',
    'Joulupaiva': 'Christmas Day',
    'Tapaninpaiva': 'Boxing Day',

    # International holidays (English -> Finnish)
    'New Year\'s Day': 'Uudenvuodenpaiva',
    'Early May Bank Holiday': 'Varhaiskevaan pankkipyha',
    'Spring Bank Holiday': 'Kevaan pankkipyha',
    'Summer Bank Holiday': 'Kesan pankkipyha',
    'Martin Luther King Jr. Day': 'Martin Luther Kingin paiva',
    'Washington\'s Birthday': 'Washingtonin syntymapaiva',
    'Memorial Day': 'Muiston paiva',
    'Independence Day': 'Itsensa turvaamisen paiva',
    'Labor Day': 'Tyontekijoiden paiva',
    'Columbus Day': 'Kolumbuksen paiva',
    'Veterans Day': 'Veteraanien paiva',
    'Thanksgiving': 'Kiitoskyyhkynen',
    'Day after Thanksgiving': 'Kiitoskyyhkysen jalkipaiva',
    'Family Day': 'Perheen paiva',
    'Victoria Day': 'Victoria-paiva',
    'Canada Day': 'Kanadan paiva',
    'Civic Holiday': 'Kansalaisten paiva',
    'Remembrance Day': 'Muistopaiva',
    'Australia Day': 'Australian paiva',
    'Easter Saturday': 'Paasiaislauantai',
    'Anzac Day': 'Anzac-paiva',
    'Queen\'s Birthday': 'Kuningattaren syntymapaiva',
    'St. Patrick\'s Day': 'St. Patrickin paiva',
    'June Bank Holiday': 'Kesakuun pankkipyha',
    'August Bank Holiday': 'Elokuun pankkipyha',
    'October Bank Holiday': 'Lokakuun pankkipyha',
    ...
    translations = {
        'fi': {
            ...
            'date': {
                ...
                'dawn': 'Sarastus klo {time}',
                'sunrise': 'aurinko nousee klo {time}',
                'noon': 'keskipäivä klo {time}',
                'sunset': 'laskee klo {time}',
                'dusk': 'hämärä klo {time}',
                'sun_position': 'Aurinko on {elevation:.1f}° korkeudella, suunta {azimuth}',
                'moon_phase': 'Kuu on {phase:.1f}% ja se on {growth}',
                'moon_position': 'Kuu on {altitude:.1f}° korkeudella, suunta {azimuth}',
                'moon_rise': 'Kuu nousee klo {time}',
                'moon_transit': 'huipussaan klo {time}',
                'moon_set': 'laskee klo {time}',
                'sun_visible': '(näkyvissä)',
                'sun_below': '(horisontin alla)',
                'moon_visible': '(näkyvissä)',
                'moon_below': '(horisontin alla)',
                'snow_depth': 'Lumen syvyys: {depth:.0f} cm',
                'cloud_cover': 'Pilvisyys: {cover}%',
                ...
                'feels_like': 'Tuntuu kuin: {temp:.1f}°c',
                'humidity': 'Ilmankosteus: {humidity}%, ilmanpaine: {pressure} hpa',
                'wind_full': 'Tuuli: {speed:.1f} m/s {dir} (puuskat {gust:.1f} m/s)',
                'wind_no_gust': 'Tuuli: {speed:.1f} m/s {dir}',
                'visibility': 'Näkyvyys: {vis:.1f} km',
                ...
                'morning_precip': 'Sateen todennäköisyys aamulla: {prob:.0f}%',
                'morning_visibility': 'Näkyvyys aamulla: {vis:.1f} km',
                'local_time': 'Paikallinen aika: {time}',
                'wind': 'Tuulen nopeus: {speed:.1f} m/s',
                'precipitation': 'Sateen todennäköisyys: {prob:.0f}%',
                ...
                'rain_warning': 'Sadevaroitus: sadetta odotettavissa',
                'snow_warning': 'Lumivaroitus: lumisadetta odotettavissa',
                ...
                'road_weather': 'Ajokeli: {condition}',
                'road_weather_reason': 'Ajokeli: {condition} ({reason})',
                'road_conditions': {'NORMAL': 'normaali', 'POOR': 'huono', 'VERY_POOR': 'erittäin huono'},
                'road_reasons': {
                    'FROST': 'pakkanen', 'SLUSH': 'sohjo', 'ICE': 'jää',
                    'SNOW': 'lumi', 'WIND': 'kova tuuli', 'DRIFTING_SNOW': 'pöllyävä lumi'
                },
                'electricity_price': 'Sähkön hinta nyt: {price:.2f} c/kWh',
                ...
                'transport_disruptions': 'Liikenteen häiriöt:',
                ...
                'compass_directions': {
                    'N': 'pohjoinen', 'NNE': 'pohjois-koillinen', 'NE': 'koillinen', 'ENE': 'itä-koillinen',
                    'E': 'itä', 'ESE': 'itä-kaakko', 'SE': 'kaakko', 'SSE': 'etelä-kaakko',
                    'S': 'etelä', 'SSW': 'etelä-lounas', 'SW': 'lounas', 'WSW': 'länsi-lounas',
                    'W': 'länsi', 'WNW': 'länsi-luode', 'NW': 'luode', 'NNW': 'pohjois-luode'
                }
            },
            'seasons': {'winter': 'talvi', 'spring': 'kevät', 'summer': 'kesä', 'autumn': 'syksy'},
            'moon_growth': {'growing': 'kasvava', 'waning': 'vähenevä'},
            'air_quality_levels': {1: 'erinomainen', 2: 'hyvä', 3: 'kohtalainen', 4: 'huono', 5: 'vaarallinen'}
        },
        'en': {
            'time_expressions': {
            ...
            'date': {
                ...
                'dusk': 'dusk at {time}',
                'sun_position': 'Sun is at {elevation:.1f}° elevation, direction {azimuth}',
                'moon_phase': 'Moon is {phase:.1f}% and it is {growth}',
                'moon_position': 'Moon is at {altitude:.1f}° elevation, direction {azimuth}',
                'moon_rise': 'Moon rises at {time}',
                'moon_transit': 'peaks at {time}',
                'moon_set': 'sets at {time}',
                'sun_visible': '(visible)',
                'sun_below': '(below horizon)',
                'moon_visible': '(visible)',
                'moon_below': '(below horizon)',
                'snow_depth': 'Snow depth: {depth:.0f} cm',
                'cloud_cover': 'Cloud cover: {cover}%',
                'solar_radiation': 'Solar radiation: {ghi:.0f} W/m² (direct: {dni:.0f} W/m²)',
                'solar_for_panels': 'For solar panels: {gti:.0f} W/m² (fixed) / {dni:.0f} W/m² (tracking)',
                'weather': 'Weather: {temp:.1f}°c, {desc}',
                'feels_like': 'Feels like: {temp:.1f}°c',
                'humidity': 'Humidity: {humidity}%, pressure: {pressure} hpa',
                'wind_full': 'Wind: {speed:.1f} m/s from {dir} (gusts {gust:.1f} m/s)',
                'wind_no_gust': 'Wind: {speed:.1f} m/s from {dir}',
                'visibility': 'Visibility: {vis:.1f} km',
                'precip_intensity': 'Precipitation intensity: {intensity:.1f} mm/h',
                'wave_info': 'Waves: {height:.1f} m, period {period:.1f} s, direction {dir}',
                'flood_discharge': 'River discharge: {discharge:.1f} m³/s',
                'flood_warning': 'Flood warning: high river discharge ({discharge:.1f} m³/s)',
                'wave_warning': 'Wave warning: high waves ({height:.1f} m)',
                'morning_forecast': 'Tomorrow morning ({date}): {temp_min:.0f}–{temp_max:.0f}°c, {desc}',
                'morning_wind': 'Morning wind: {wind:.0f} m/s (gusts {gust:.0f} m/s)',
                'morning_precip': 'Morning precipitation probability: {prob:.0f}%',
                'morning_visibility': 'Morning visibility: {vis:.1f} km',
                ...
                'air_quality_warning': 'Air quality warning: poor air quality, avoid outdoor activities',
                'road_weather': 'Road conditions: {condition}',
                'road_weather_reason': 'Road conditions: {condition} ({reason})',
                'road_conditions': {'NORMAL': 'normal', 'POOR': 'poor', 'VERY_POOR': 'very poor'},
                'road_reasons': {
                    'FROST': 'frost', 'SLUSH': 'slush', 'ICE': 'ice',
                    'SNOW': 'snow', 'WIND': 'high wind', 'DRIFTING_SNOW': 'drifting snow'
                },
                ...
                'aurora_forecast': 'Aurora forecast: Kp {kp:.0f}',
                ...
                'aurora_unlikely': 'Aurora forecast: Kp {kp:.0f} (unlikely)',
                'next_eclipse_solar': 'Next solar eclipse: {date} ({type})',
                ...
                'transport_disruptions': 'Transport disruptions:',
                'no_disruptions': 'No disruptions',
            ...
            'moon_growth': {'growing': 'growing', 'waning': 'waning'},
