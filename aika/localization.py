...
def get_translations(language):
    ...
    translations = {'fi': {'time_expressions': {'nearly_ten_to_two': 'noin kymmentä vaille kaksi', 'half_past_one': 'noin puoli yksi',
                           ...
                           'date': {'week': 'Viikko', 'day': 'Päivä', 'year_complete': 'Vuosi on {pct:.1f} % valmis', 'dawn': 'Sarastus klo {time}',
                                    ...
                                    'daylight_length': 'Päivän pituus: {hours:.1f} h ({change} min eilisestä)',
                                    'daylight_same': 'Päivän pituus: {hours:.1f} h (sama kuin eilen)',
                                    'time_to_sunrise': 'Aikaa auringonnousuun: {minutes} min',
                                    'time_to_sunset': 'Aikaa auringonlaskuun: {minutes} min',
                                    'golden_hour_morning': 'Aamun kultainen hetki: {start}-{end}',
                                    'golden_hour_evening': 'Illan kultainen hetki: {start}-{end}',
                                    'blue_hour_morning': 'Aamun sininen hetki: {start}-{end}',
                                    'blue_hour_evening': 'Illan sininen hetki: {start}-{end}',
                                    'golden_hour_now': 'Kultainen hetki käynnissä!',
                                    'blue_hour_now': 'Sininen hetki käynnissä!',
                                    'rain_starts_in': 'Sade alkaa {minutes} minuutin kuluttua',
                                    'rain_ends_in': 'Sade loppuu {minutes} minuutin kuluttua',
                                    'no_rain_2h': 'Ei sadetta seuraavan 2 tunnin aikana',
                                    'currently_raining': 'Sataa nyt ({type})',
                                    'precip_types': {'rain': 'vesisade', 'snow': 'lumisade', 'mixed': 'räntä', 'none': ''},
                                    'forecast_12h_rain': 'Sadetta klo {start}-{end}',
                                    'forecast_12h_no_rain': 'Ei sadetta seuraavan 12 tunnin aikana',
                                    ...
                                    'temp_trend_stable': 'Lämpötila vakaa ({min:.0f}-{max:.0f}°C)',
                                    'best_outdoor_day': 'Paras ulkoilupäivä: {day} ({reason})',
        ...
        'date': {'week': 'Week', 'day': 'Day', 'year_complete': 'The year is {pct:.1f} % complete', 'dawn': 'Dawn at {time}', 'sunrise': 'sunrise at {time}',
                 ...
                 'daylight_length': 'Day length: {hours:.1f} h ({change} min from yesterday)',
                 'daylight_same': 'Day length: {hours:.1f} h (same as yesterday)',
                 'time_to_sunrise': 'Time to sunrise: {minutes} min',
                 'time_to_sunset': 'Time to sunset: {minutes} min',
                 'golden_hour_morning': 'Morning golden hour: {start}-{end}',
                 'golden_hour_evening': 'Evening golden hour: {start}-{end}',
                 'blue_hour_morning': 'Morning blue hour: {start}-{end}',
                 'blue_hour_evening': 'Evening blue hour: {start}-{end}',
                 'golden_hour_now': 'Golden hour in progress!',
                 'blue_hour_now': 'Blue hour in progress!',
                 'rain_starts_in': 'Rain starts in {minutes} minutes',
                 'rain_ends_in': 'Rain ends in {minutes} minutes',
                 'no_rain_2h': 'No rain expected in the next 2 hours',
                 'currently_raining': 'Currently raining ({type})',
                 'precip_types': {'rain': 'rain', 'snow': 'snow', 'mixed': 'sleet', 'none': ''},
                 'forecast_12h_rain': 'Rain at {start}-{end}',
                 'forecast_12h_no_rain': 'No rain expected in the next 12 hours',
                 'forecast_wind_peak': 'Peak wind at {time}: {speed:.0f} m/s',
                 'temp_trend_rising': 'Temperature rising ({min:.0f} -> {max:.0f}°C)',
                 'temp_trend_falling': 'Temperature falling ({max:.0f} -> {min:.0f}°C)',
                 'temp_trend_stable': 'Temperature stable ({min:.0f}-{max:.0f}°C)',
                 'best_outdoor_day': 'Best outdoor day: {day} ({reason})',
                 'snow_accumulation': 'Snow accumulation forecast: {cm:.0f} cm',
                 ...
                 'season': 'Season: {season}', 'name_day': 'Name day: {names}',
